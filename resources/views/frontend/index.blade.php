            ...
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="banner-content">
                    ...
                    <div class="banner-btn">
                        <button id="reg-dashboard-btn" class="btn--base reg-dashboard-btn"><i aria-hidden="true" class="far fa-credit-card" style="color: white;"></i> &nbsp;{{ __(@$banner->value->language->$lang->button_name) }}</button>
