        ...
        <div class="row align-items-center mb-30-none">
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="banner-content">
                    ...
                    @endphp
                    <h1 class="title">{{ @$heading[0] }} {{ @$heading[1] }} {{ @$heading[2] }} {{ @$heading[4] }}  <span class="text--base" style="color: #1b756b !important; border-radius: 50px 50px 50px 50px; padding: 15px 30px 15px 30px;"><i aria-hidden="true" class="far fa-credit-card"></i> {{ @$heading[5] }}  {{ @$heading[6] }}</span>  {{ @$heading[7] }}</h1>
