                                        ...
                                        <div class="dash-payment-body">
                                            <form class="card-form" action="{{ setRoute("user.add.money.manual.payment.confirmed") }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                @endforeach
                                                    ...
                                                    <a href="https://www.instamojo.com/@Lexus_card/ld15a864cfdec4ec99fd3d3d8b155f579/" rel="im-checkout" data-text="Pay Now" data-css-style="color:#000000; background:#ffffff; width:300px; border-radius:30px"   data-layout="vertical"></a>
