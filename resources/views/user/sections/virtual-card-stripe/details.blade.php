                        ...
                        <div class="card-custom">
                            <div class="flip">
                                <div class="front bg_img" data-background="{{ asset('public/frontend/') }}/images/element/card.png">
                                    ...
                                    @php
                                    $masked_card_no = $myCard->maskedPan
                                    @endphp
                                    <div class="card-number card-n">
                                        @php
                                        $card_pan = str_split($masked_card_no, 4);
                                        @endphp
                                        @foreach($card_pan as $key => $value)
                                        <div class="section card-num">{{ $value }}</div>
                                        @endforeach
                                    </div>
